    ...
    return <div style={{display: 'flex', flexWrap: 'wrap'}}>
        <table>
            ...
            <tr>
                ...
                <td style={{paddingLeft: '8px'}}>{"/s（单个油井）"}</td>
            </tr>
            <tr>
                <td>巨星氢面板</td>
                <td style={{paddingLeft: '8px'}}>
                ...
                <td style={{paddingLeft: '8px'}}>{"/s（星球资源详情）"}</td>
            </tr>
            <tr>
                <td>巨星重氢面板</td>
                <td style={{paddingLeft: '8px'}}>
        ...
        <table>
            ...
            <tr>
                <td>原矿显示</td>
                <td style={{paddingLeft: '8px'}}>{settings.hide_mines ? "隐藏原矿" : "显示原矿"}</td>
                <td style={{paddingLeft: '8px'}}>
                    <mdui-button variant="text" onClick={e => change_bool_setting(e, "hide_mines")}>
                        {settings.hide_mines ? "显示原矿" : "隐藏原矿"}</mdui-button>
                </td>
            </tr>
            <tr>
                <td>小矿机覆盖矿脉数</td>
            ...
            <tr>
                ...
                <td style={{paddingLeft: '8px'}}>{"%（科技面板右上）"}</td>
            </tr>
            <tr>
                <td>残骸产出倍率</td>
                <td style={{paddingLeft: '8px'}}>
            ...
            <tr>
                ...
                <td style={{paddingLeft: '8px'}}>{settings.is_time_unit_minute ? "/min" : "/sec"}</td>
            </tr>
            </tbody>
        </table>
        <table>
            ...
            <tr>
                <td>速率单位</td>
                <td style={{paddingLeft: '8px'}}>{settings.is_time_unit_minute ? "个/min" : "个/sec"}</td>
                <td style={{paddingLeft: '8px'}}>
                    <mdui-button variant="text" onClick={e => change_bool_setting(e, "is_time_unit_minute")}>
                        {settings.is_time_unit_minute ? "转化为秒" : "转化为分"}</mdui-button>
                </td>
            </tr>
            <tr>
                <td>精度位数</td>
            ...
            <tr>
                <td>增产剂自喷涂</td>
                <td style={{paddingLeft: '8px'}}>{settings.proliferate_itself ? "启用" : "禁用"}</td>
                <td style={{paddingLeft: '8px'}}>
                    <mdui-button variant="text" onClick={e => change_bool_setting(e, "proliferate_itself")}>
                        {settings.proliferate_itself ? "改为禁用" : "改为启用"}</mdui-button>
                </td>
            </tr>
            <tr>
                <td>增产剂加速效率修正</td>
        ...
        <table style={{display: TheyComeFromVoidEnable}}>
            ...
            <tr>
                ...
                <td style={{paddingLeft: '8px'}}>{settings.blue_buff ? "启用" : "禁用"}</td>
                <td style={{paddingLeft: '8px'}}>
                    <mdui-button variant="text" onClick={e => change_bool_setting(e, "blue_buff")}>
                        {settings.blue_buff ? "改为禁用" : "改为启用"}</mdui-button>
                </td>
            </tr>
            </tbody>
        </table>
